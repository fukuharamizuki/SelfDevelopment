	...
	<div class="input-area2">
		<form method="post" action="masterItemUpdata">
			...
			<div class="form-group row">
				...
				<div class="col-sm-8">
					<input type="text" class="form-control" name="rPrice" id="inputPrice2" value="${idb.RPrice}">
				</div>
			</div>
			<div class="form-group row">
				<label for="inputPrice" class="col-sm-4 col-form-label">価格(購入)</label>
				<div class="col-sm-8">
					<input type="text" class="form-control" name="price" id="inputPrice" value="${idb.price}">
				</div>
			</div>
			<div class="form-group row">
