	...
	<div class="input-area2">
		<form method="post" action="masterCreateItem">
			<div class="form-group row">
				...
				<div class="col-sm-6">
					<input type="text" class="form-control" name="itemname" id="inputItem" placeholder="" required>
				</div>
			</div>
			<div class="form-group row">
				<label for="inputPrice1" class="col-sm-4 col-form-label">価格(レンタル)</label>
				<div class="col-sm-6">
					<input type="text" class="form-control" name="rPrice" id="inputPrice1" placeholder="半角で入力してください" required>
				</div>
			</div>
			<div class="form-group row">
				<label for="inputPrice2" class="col-sm-4 col-form-label">価格(購入)</label>
				<div class="col-sm-6">
					<input type="text" class="form-control" name="price" id="inputPrice2" placeholder="半角で入力してください" required>
				</div>
			</div>
			<div class="form-group row">
				<label for="inputData" class="col-sm-4 col-form-label">詳細</label>
				<div class="col-sm-6">
					<input type="text" class="form-control" name="detail" id="inputData" placeholder="" required>
				</div>
			</div>
			<div class="form-group row">
				<label for="inputData" class="col-sm-4 col-form-label">タイプ</label>
				<div class="col-sm-6">
					<input type="text" class="form-control" name="type" id="inputData" placeholder="1~4の半角で入力してください" required>
				</div>
			</div>
			<br>
